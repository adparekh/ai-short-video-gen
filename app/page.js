      ...
      <div>
        ...
        <section className="py-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <h2 className="text-md text-gray-500">
            Follow the three steps below to let AI generate your short video.
          </h2>
       ...
       hover:border-pink-500/10 hover:shadow-pink-500/10"
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-600">
                Choose between the options available or give your custom prompt.
              </p>
            </a>
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-600">
                Choose between Animated, Cartoon, Comic, Realistic, and
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-600">
                Press Generate, sit back and let the AI do its magic.
              </p>
            </a>
          </div>
